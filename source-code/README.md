...
```
vendor/bin/phpunit tests/unit/Espo/Modules/LinkConditionOptions
```
...
```
vendor/bin/phpunit tests/integration/Espo/Modules/LinkConditionOptions
```
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/LinkConditionOptions`
* `site/tests/integration/Espo/Modules/LinkConditionOptions`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/LinkConditionOptions/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/LinkConditionOptions/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/link-condition-options/lib/init.js"
        ]
    }
    ```
